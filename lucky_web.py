...
def set_png_as_page_bg(bin_file):
    try:
        ...
        .stApp {{ color: #00ff9f; font-family: 'Share+Tech+Mono', monospace; }}
        .glitch-title {{ text-align: center; color: #fcee0a; text-shadow: 3px 3px #ff003c; font-family: 'Orbitron', sans-serif; font-size: 3rem; margin-bottom: 30px; }}
        .stButton>button {{ background: #fcee0a; color: #000; font-family: 'Orbitron', sans-serif; font-weight: bold; border: none; clip-path: polygon(15% 0, 100% 0, 100% 70%, 85% 100%, 0 100%, 0% 30%); padding: 12px 30px; transition: 0.3s; width: 100%; }}
        .stButton>button:hover {{ background: #00f0ff; box-shadow: 0 0 20px #00f0ff; color: #000; }}
